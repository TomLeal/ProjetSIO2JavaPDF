...
public class Pdf {
    ...
    public void genererPDF() throws FileNotFoundException, BadElementException, IOException {
        try {
            ...
            para1.add(new Paragraph("Saupagna Lorenzo", f2));
            para1.add(new Paragraph("11 rue de ma maison", f1));
            para1.add(new Paragraph("66666", f1));
            para1.add(new Paragraph("France Du Sud", f1));
            para1.add(new Paragraph("lorenzo.saupalin.66@gmail.com", f3));
            para1.add(new Paragraph("06 06 06 06 06", f1));
             ...
             */
            PdfPCell espaces = new PdfPCell(new Phrase(""));
            Paragraph espace = new Paragraph(" • Debut:",f3);
            espace.add(new Paragraph("BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA ",f1));
            espace.add(new Paragraph("BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA BLA ",f1));
            espace.add(new Paragraph("fin.",f1));
            espaces.addElement(espace);
            espaces.addElement(espace);

            espaces.setBorderColor(BaseColor.WHITE);
            /**
             ...
             */
            PdfPCell Informatique = new PdfPCell(new Phrase(""));
            Paragraph Informa = new Paragraph("INFORMATIQUE", f5);
            Informa.add(new Paragraph(" ", f6));
            Informatique.setBorderColor(BaseColor.WHITE);
            Informatique.addElement(Informa);
            /**
